...
public class ArrayInArrayExample {
	...
	public static void main(String[] args) {
		...
		System.out.println(scores1[0].length);	// 3 (첫번쨰 행의 3개의 열이 있음)
		System.out.println(scores1[1].length);	// 3 (두번쨰 행의 3개의 열이 있음)
		
		System.out.println(scores2.length);	// 4
		
		int[][] scores3 = new int[2][];	
		scores3[0] = new int[2];				//(첫번쨰 행의 2개의 열을 만듬)
		scores3[1] = new int[2];				//(두번쨰 행의 2개의 열을 만듬)
		
		// 다차원 배열 생성과 초기화 같이 하는 방법
		int[][] scores4 = { {95, 80}, {92, 96} }; // 2개의 행과 2개의 열 공간을 만듬
		System.out.println(scores4[0][1]);	// 80 (첫밴째 행과 2번째 열)
		System.out.println(scores4[1][1]);	// 96 (두밴째 행과 2번째 열)
